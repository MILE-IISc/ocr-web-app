...
router.put("", checkAuth, (req, res, next) => {
  ...
  .then(user => {
    ...
    // const user_xml_dir = './backend/images/' + fetchedUser.email + '/';
    ...
    doCreateObject(fetchedUser.bucketName, xmlFileName, formattedXml.join("\n")).then(() => {
...
router.get("/:fileName", checkAuth,(req, res, next) =>{
  ...
  .then(user => {
    ...
    const user_wav_dir = './backend/images/'+ fetchedUser.email + '/' + XmlfileName;
    // getItem(bucket, XmlfileName);
    getItem(fetchedUser.bucketName, XmlfileName).then(content => {
